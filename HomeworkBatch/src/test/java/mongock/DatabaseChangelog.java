...
public class DatabaseChangelog {
    ...
    public void insertBooks(BookDao repository) {
        book1 = repository.save(new Book("1", "Capital", author1, genre1, List.of()));
        book2 = repository.save(new Book("2", "Compositions", author2, genre2, List.of()));
        book3 = repository.save(new Book("3", "Imperialism as the highest stage of capitalism", author3, genre3, List.of()));
