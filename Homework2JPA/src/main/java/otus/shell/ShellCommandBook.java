...
public class ShellCommandBook {
    ...
    public void getComments() {
        Book book = bookService.getBook(ioService.getLong(INPUT_ID_BOOK));
        if (book == null) {
    ...
    private void fillBookField(Book book) {
        Author author = authorService.getAuthor(ioService.getLong(INPUT_ID_AUTHOR));
        if (author == null) {
            ioService.outputString(NOT_FIND);
    ...
    private void setGenre(Book book) {
        Genre genre = genreService.getGenre(ioService.getLong(INPUT_ID_GENRE));
        if (genre == null) {
            ioService.outputString(NOT_FIND);
