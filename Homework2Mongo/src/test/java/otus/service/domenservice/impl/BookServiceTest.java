...
class BookServiceTest {
    ...
    @BeforeEach
    public void setUp() {
        author = new Author("1", "Karl", "Marks");
        genre = new Genre("1", "Roman");
    ...
    void saveBook() {
        ...
        when(genreService.getGenre("1")).thenReturn(genre);
    ...
    void getBook() {
        when(ioService.getString()).thenReturn("1");
        when(bookDao.findById("1")).thenReturn(Optional.of(expected));
